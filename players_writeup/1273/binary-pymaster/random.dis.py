...
# Decompiled from: Python 3.12.6 (main, Sep  9 2024, 00:00:00) [GCC 14.2.1 20240801 (Red Hat 14.2.1-1)]
    ...
    class Random(_random.Random):
        ...
        """
            if version == 1 and isinstance(a, (str, bytes)):
                ...
                for c in map(ord, a):
                    x = (1000003 * x ^ c) & 18446744073709551615L
        ...
        def setstate(self, state):
            ...
            if version == 3:
                ...
                (version, internalstate, self.gauss_next) = state
                try:
                    internalstate = tuple((x % 4294967296L for x in internalstate))
